...
Square::Square(ID3D11Device* device, const ShaderData& shaderData) :
...
void Square::render(ID3D11DeviceContext* immediateContext, float topLeftPositionX, float topLeftPositionY,
